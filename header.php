	...
	<nav class="navbar">
		<div class="container">
			<div class="navbar-header">
				...
				<a class="navbar-brand visible-xs" href="#">Australian Open Government Partnership Civil Society Network</a>
			</div>
		...
		<div class="container">
			<div class="row">
				<div class="col col-sm-5">
					...
					<h1><span>Australian</span> Open Government Partnership Civil Society Network</h1>
				</div>
